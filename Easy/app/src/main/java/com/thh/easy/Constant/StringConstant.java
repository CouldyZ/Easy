...
public class StringConstant {
    ...
    // 用户登陆Action
    public final static String SERVER_LOGIN_URL = SERVER_IP +
            "/thhh/user/android_loginCheck.action";

    // 用户注册 Action
    public final static String SERVER_REG_URL = SERVER_IP +
            "/thhh/user/android_register.action";
    ...
    // 最新帖子
    public final static String SERVER_NEWPOST_URL = SERVER_IP +
            "/thhh/posts/android_posts_newPosts.action";

    // 最热帖子
    public final static String SERVER_HOTPOST_URL = SERVER_IP +
            "/thhh/posts/android_posts_hotPosts.action";

    // 查看评论
    public final static String SERVER_COMMENT_URL = SERVER_IP +
            "/thhh/posts/android_comments_seeComment.action";

    // 发送评论
    public final static String SERVER_ADDCOMMENT_URL = SERVER_IP +
            "/thhh/posts/android_comments_addComments.action";

    // 点赞
    public final static String SERVER_LIKE_URL = SERVER_IP +
    ...
    // 查看商店
    public final static String SERVER_SHOP_URL = SERVER_IP +
            "/thhh/goods/android_goods_seekShop.action";

    // 查看商品
    public final static String SERVER_GOODS_URL = SERVER_IP +
            "/thhh/goods/android_goods_seekGoods.action?";

    // 下订单
    public final static String SERVER_CONFIRM_ORDER = SERVER_IP +
            "/thhh/goods/android_order_buy.action";

    // 查看订单
    public final static String SERVER_ORDER_URL = SERVER_IP +
            "/thhh/goods/android_order_seeOrders.action";
